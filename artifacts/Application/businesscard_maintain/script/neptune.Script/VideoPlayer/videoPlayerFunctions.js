...
//DONE IN NAVIGATION EVENT OF LIST!!!
...
function loadVideo() {
    var videoID = VideoLink.getText(); // Get new Video ID

    if (player) {
        console.log("Loading new video: " + videoID);
        player.loadVideoById(videoID); // Load new video without destroying the player
        return; // Exit function to avoid re-initialization
    }
